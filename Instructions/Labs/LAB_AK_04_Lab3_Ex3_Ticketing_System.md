...
<li>Once the <strong>Navigator</strong> window appears, this is your indication that you have established a connection between the IT Consultant&rsquo;s PC (LON-CL1) and Adatum&rsquo;s IT Services site that Holly created in the prior task. Even though you used the <strong>Get Data</strong> command in Excel to do this, you will NOT import any data locally to the Excel spreadsheet (the data is already in the spreadsheet).
